...
const PromptDetailModal = ({
  ...
  const displayDate = createdAt ? new Date(createdAt).toLocaleDateString(undefined, { month: 'short', day: 'numeric', year: 'numeric' }) : null;
          ...
          <div className="grid md:grid-cols-2 gap-0">
            ...
            <div className="p-8 flex flex-col">
              ...
              <p className="text-sm text-gray-500 mb-6">
                Generated with <span className="font-medium text-gray-800">{generator}</span>
